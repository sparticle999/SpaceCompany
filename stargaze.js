Game.stargaze = (function(){
	...
	instance.resetVars = function(){
		researchUnlocked=!1,researched=[],available=[],explored=[],tabsUnlocked=[],resourcesUnlocked=[],noBorder=[],rocketLaunched=!1,buttonsHidden=[],activated=[],techUnlocked=!1,meteoriteUnlocked=!1,globalEnergyLock=!1,heater=0,heaterToggled=!0,plasmatic=0,plasmaticToggled=!0,battery=0,batteryMetalCost=5e4,batteryGemCost=5e4,batteryLunariteCost=3e4,batteryT2=0,batteryT2MetalCost=55e4,batteryT2GemCost=55e4,batteryT2LunariteCost=33e4,batteryT3=0,batteryT3MetalCost=55e5,batteryT3GemCost=55e5,batteryT3LunariteCost=33e5,batteryT4=0,batteryT4MetalCost=55e6,batteryT4GemCost=55e6,batteryT4LunariteCost=33e6,PSU=0,PSUSilverCost=77e4,PSUGoldCost=77e4,PSUUraniumCost=55e4,PSUT2=0,PSUT2SilverCost=93e5,PSUT2GoldCost=93e5,PSUT2UraniumCost=68e5,charcoalEngine=0,solarPanel=0,methaneStation=0,nuclearStation=0,magmatic=0,fusionReactor=0,pump=0,pumpjack=0,oilField=0,oilRig=0,miner=0,heavyDrill=0,gigaDrill=0,quantumDrill=0,gemMiner=0,advancedDrill=0,diamondDrill=0,carbyneDrill=0,charcoalToggled=!0,woodburner=0,furnace=0,kiln=0,fryer=0,woodcutter=0,laserCutter=0,deforester=0,infuser=0,moonWorker=0,moonDrill=0,moonQuarry=0,planetExcavator=0,vacuum=0,suctionExcavator=0,spaceCow=0,vent=0,explorer=0,lunariteDrill=0,pentaDrill=0,titanDrill=0,droid=0,destroyer=0,deathStar=0,actuator=0,scout=0,spaceLaser=0,bertha=0,cannon=0,blowtorch=0,scorcher=0,annihilator=0,desert=0,grinder=0,cubic=0,enricher=0,recycler=0,crucible=0,extractor=0,extruder=0,veluptuator=0,collector=0,magnet=0,eCell=0,hindenburg=0,drone=0,tanker=0,compressor=0,skimmer=0,icePick=0,iceDrill=0,freezer=0,mrFreeze=0,meteoriteToggled=!0,printer=0,web=0,smasher=0,nebulous=0,planetNuke=0,condensator=0,fossilator=0,multiDrill=0,diamondChamber=0,microPollutor=0,forest=0,cloner=0,interCow=0,club=0,philosopher=0,werewolf=0,tardis=0,harvester=0,cage=0,overexchange=0,lab=0,labT2=0,labT3=0,labT4=0,labT5=0,rocket=0,rocketFuelToggled=!0,chemicalPlant=0,oxidisation=0,hydrazine=0,dyson=0,dysonTitaniumCost=3e5,dysonGoldCost=1e5,dysonSiliconCost=2e5,dysonMeteoriteCost=1e3,dysonIceCost=1e5,ring=0,swarm=0,sphere=0,antimatter=0,antimatterps=0,antimatterToggled=!0;
	};
