...
function getGigaDrill(){
	if(spaceMetal >= gigaDrillSpaceMetalCost && gem >= gigaDrillGemCost && silicon >= gigaDrillSiliconCost){
		...
		gigaDrill += 1;
		gigaDrillSiliconCost = Math.floor(4100 * Math.pow(1.1,gigaDrill + 1));
		gigaDrillGemCost = Math.floor(3400 * Math.pow(1.1,gigaDrill + 1));
		gigaDrillSpaceMetalCost = Math.floor(2800 * Math.pow(1.1,gigaDrill + 1));
...
function getDeforester(){
	if(spaceMetal >= deforesterSpaceMetalCost && titanium >= deforesterTitaniumCost && silicon >= deforesterSiliconCost){
		...
		deforester += 1;
		deforesterSpaceMetalCost = Math.floor(3000 * Math.pow(1.1,deforester + 1));
		deforesterTitaniumCost = Math.floor(2700 * Math.pow(1.1,deforester + 1));
		deforesterSiliconCost = Math.floor(2500 * Math.pow(1.1,deforester + 1));
...
function getDeathStar(){
	if(spaceMetal >= deathStarSpaceMetalCost && silver >= deathStarSilverCost && silicon >= deathStarSiliconCost){
		...
		deathStar += 1;
		deathStarSiliconCost = Math.floor(8200 * Math.pow(1.1,deathStar + 1));
		deathStarSilverCost = Math.floor(11500 * Math.pow(1.1,deathStar + 1));
		deathStarSpaceMetalCost = Math.floor(17000 * Math.pow(1.1,deathStar + 1));
