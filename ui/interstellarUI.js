                        ...
                        '<div class="modal-dialog modal-lg">',
                            '<div class="modal-content">',
                                ...
                                '<div class="modal-body">',
                                    '<span>This is where you can send ships to reconnoiter your enemies\' fleets. When successful at the first level, you will be able to see the number of digits in the enemy fleet statistics, with the second revealing the first digit in all three stats and each successive level will reveal the next digit. There are no decimal places.</span>',
                                '</div>',
                                '<div class="modal-body">',
                    ...
                    '<div id="{{htmlId}}_invade" class="modal fade" role="dialog">',
                        '<div class="modal-dialog modal-lg">',
                            '<div class="modal-content">',
                                ...
                                '</div>',
                                '<div class="modal-body">',
                                    '<span>Here, you can activate ships in your fleet and attempt to invade the star system. You reputation with the owner affects how prepared they are for the possibility of invasion. The defense fleet statistics take this into account already, so no extra calculation is needed. Invading has a negative impact on your reputation with the faction in question, reducing it by 10 for a successful invasion. However, due to their large ego, your enemies take pity on failed attempts and reputation is not changed if you lose.</span>',
                                '</div>',
                                '<div class="modal-body">',
                    ...
                    '<div id="{{htmlId}}_absorb" class="modal fade" role="dialog">',
                        '<div class="modal-dialog modal-lg">',
                            '<div class="modal-content">',
                                ...
                                '</div>',
                                '<div class="modal-body">',
                                    '<span>Absorption is the simplest way to conquer a star system. Unfortunately, you must be on good terms with the owner faction: You need at least 60 reputation with them for Absorbption to be possible. For Absorbing a system, you will lose 5 reputation, which is half the amount you would lose in a successful invasion.</span>',
                                '</div>',
                                '<div class="modal-body">',
