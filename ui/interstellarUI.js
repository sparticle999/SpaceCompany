Game.interstellarUI = (function(){
    ...
    instance.initialise = function() {
        ...
        instance.factionStarTemplate = Handlebars.compile(
            ['<tr id="{{htmlId}}_conquer" class="hidden"><td colspan="1" id="{{htmlId}}_info">',
                ...
                '</h5><hide id="{{htmlId}}_conquerButtons">',
                    ...
                    // Forced Submission
                    '<div class="btn btn-default" data-toggle="modal" data-target="#{{htmlId}}_force">Forced Submission</div>',
                    '<div id="{{htmlId}}_force" class="modal fade" role="dialog">',
                        '<div class="modal-dialog modal-lg">',
                            '<div class="modal-content">',
                                '<div class="modal-header">',
                                    '<button type="button" class="close" data-dismiss="modal">&times;</button>',
                                ...
                                '</div>',
                                '<div class="modal-body">',
                                    '<span>Show your might and dominate your enemies with fear. If you have more than 200% chance victory, you can force the star system to submit to your rule peacefully, and make them be more content with the inevitability of your takeover.</span>',
                                '</div>',
                                '<div class="modal-body">',
                                    '<table class="table"><tr><td id="{{htmlId}}_forceShips" style="width:33%">',
                                        '<h4>Active Ships:</h4>',
                                        /***************************
                                        ** Add Ships Procedurally **
                                        ***************************/
                                    ...
                                    '</td><td style="text-align:center; width:33%">',
                                        '<h4>Threat Level: (<span class="{{htmlId}}_threat">•</span>)</h4>',
                                        '<h4>Chance of Victory: <span class="{{htmlId}}_forceChance">0</span>%</h4>',
                                        '<button class="btn btn-default" id="{{htmlId}}_forceButton" data-dismiss="modal" onclick="Game.interstellar.military.forceSystem(\'{{id}}\');">Attack!</button>',
                                    '</td></tr></table>',
                                '</div>',
                                '<div class="modal-footer">',
                                    '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>',
        ...
        instance.planetBuildingTemplate = Handlebars.compile(
            ['<h5>{{name}}:<img src="Icons/{{icon}}.png" style="width:30px; height:auto"></h5>',
