...
Templates.machinesUI = function(cPage, cCategory, cTitle, cObj) {
	...
	var TemplateTableResource = Handlebars.compile(
		['<tr>',
			'<td colspan="1">',
				'<button id="'+this.page+'_{{id}}_deactivate_10000" class="btn btn-default">--</button>',
			'</td>',
			'<td colspan="1">',
				'<button id="'+this.page+'_{{id}}_deactivate_1" class="btn btn-default">-</button>',
			'</td>',
			'<td colspan="1">',
			...
			'<td colspan="1">',
				...
				'<span id="'+this.page+'_{{id}}_active">{{active}}</span>/<span id="'+this.page+'_{{id}}_current">{{current}}</span>',
				'</h5>',
			'</td>',
			'<td colspan="1">',
			...
			'<td colspan="1">',
				'<h5 class="default btn-link">',
					'<span id="{{id}}Prod">0</span>/sec',
				'</h5>',
			'</td>',
			'<td colspan="1">',
				'<h5 class="default btn-link">',
					'<span id="{{id}}Use">0</span>/sec',
				'</h5>',
			'</td>',
		'</tr>',
		 ''].join('\n'));
