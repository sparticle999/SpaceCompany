Game.resourcesUI = (function(){
	...
	instance.initialise = function() {
        ...
        instance.machineTemplate = Handlebars.compile(
            ...
            '<div id="{{htmlId}}_buy_10" onclick="Game.buildings.buyBuildings(\'{{id}}\', 10)" class="btn btn-default">Get 10</div>',
            '<div id="{{htmlId}}_buy_100" onclick="Game.buildings.buyBuildings(\'{{id}}\', 100)" class="btn btn-default">Get 100</div>',
            '<div id="{{htmlId}}_buy_max" onclick="Game.buildings.buyBuildings(\'{{id}}\', 10000)" class="btn btn-default">Get Max</div>',
            '</hide>',
